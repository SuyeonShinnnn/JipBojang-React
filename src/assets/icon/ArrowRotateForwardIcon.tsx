...
interface ArrowRotateForwardIconProps extends React.SVGProps<SVGSVGElement> {}

export const ArrowRotateForwardIcon: React.FC<ArrowRotateForwardIconProps> = (props) => {
  return (
