...
interface MagnifyingGlassPlusIconProps extends React.SVGProps<SVGSVGElement> {}

export const MagnifyingGlassPlusIcon: React.FC<MagnifyingGlassPlusIconProps> = (props) => {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
